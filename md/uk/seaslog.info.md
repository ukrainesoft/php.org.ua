...
public static **SeasLog::info**(string `$message`, array `$content` u003d ?,
...
` <?phpvar_dump(SeasLog::info('log message'));//с contentvar_dump(SeasLog::info('log message from {NAME}',array('NAME' u003d> 'neeke'))); //з часовим loggervar_dump(SeasLog::info('log message from {NAME}',array('NAME' u003d> 'neeke'),'tmp_logger'));var_dump(SeasLog::getBuffer());?> `
